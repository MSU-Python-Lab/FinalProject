                ...
                <div className="mx-auto max-w-8xl">
                    <div className="flex flex-col h-screen lg:flex-row">
                        ...
                        <div className="w-full bg-white mr-20 lg:w-6/12 xl:w-1/2 md:mr-0">
                            <div
                                className="flex flex-col items-start justify-center w-full h-full p-10 lg:p-16 xl:p-24">
                                ...
                                <div className="relative w-full mt-5 space-y-3 md:space-y-1">
                                    ...
                                    <div className="flex">
                                        ...
                                        <input type="password"
                                               id="bl7"
                                               className="block w-full px-4 py-3 mt-2 text-xl placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-[#148290] rounded-2xl"
